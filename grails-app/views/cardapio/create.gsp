...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'mesa.label', default: 'Cardapio')}" /> <!-- ALTER ENTIDADE-->
...
<div id="page-inner">
    <div class="col-md-10 col-sm-10">
        ...
        <!--Mensagens de Alerta e de Erro -->
            ...
            <g:hasErrors bean="${cardapioInstance}"> <!-- ALTER ENTIDADE-->
                <ul class="alert alert-danger close" role="alert">
                    <g:eachError bean="${cardapioInstance}" var="error"> <!-- ALTER ENTIDADE-->
            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="formulario" >
                        ...
                        <div id="create-cardapio" class="content scaffold-create" role="main"> <!-- ALTER ENTIDADE-->
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <!-- #################### FIM INICIO DIV ADICIONADO 2 ########################### -->
                                                <g:uploadForm url="[resource:cardapioInstance, action:'save']"  > <!-- ALTER ENTIDADE-->
                                                    <fieldset class="form">
