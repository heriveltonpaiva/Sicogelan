	...
	<body>
		...
		<div id="show-produto" class="content scaffold-show" role="main">
			...
			<ol class="property-list produto">
				...
				<g:if test="${produtoInstance?.quantidadeReal}">
				<li class="fieldcontain">
					<span id="quantidadeReal-label" class="property-label"><g:message code="produto.quantidadeReal.label" default="Quantidade Real" /></span>
					
						<span class="property-value" aria-labelledby="quantidadeReal-label"><g:fieldValue bean="${produtoInstance}" field="quantidadeReal"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${produtoInstance?.quantidadeMinima}">
				<li class="fieldcontain">
					<span id="quantidadeMinima-label" class="property-label"><g:message code="produto.quantidadeMinima.label" default="Quantidade Minima" /></span>
					
						<span class="property-value" aria-labelledby="quantidadeMinima-label"><g:fieldValue bean="${produtoInstance}" field="quantidadeMinima"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${produtoInstance?.quantidadeMinimaReal}">
				<li class="fieldcontain">
					<span id="quantidadeMinimaReal-label" class="property-label"><g:message code="produto.quantidadeMinimaReal.label" default="Quantidade Minima Real" /></span>
					
						<span class="property-value" aria-labelledby="quantidadeMinimaReal-label"><g:fieldValue bean="${produtoInstance}" field="quantidadeMinimaReal"/></span>
