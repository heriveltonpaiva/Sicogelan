...
<html>
	...
	<body>
		<a href="#list-categoriaOpcaoCardapio" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-categoriaOpcaoCardapio" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${categoriaOpcaoCardapioInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
