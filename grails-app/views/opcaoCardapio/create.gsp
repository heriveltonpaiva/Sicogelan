...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'opcaoCardapio.label', default: 'OpcaoCardapio')}" /> <!-- ALTER ENTIDADE-->
...
<div id="page-inner">
    <div class="col-md-10 col-sm-10">
        ...
        <!--Mensagens de Alerta e de Erro -->
            ...
            <g:hasErrors bean="${opcaoCardapioInstance}"> <!-- ALTER ENTIDADE-->
                <ul class="alert alert-danger close" role="alert">
                    <g:eachError bean="${opcaoCardapioInstance}" var="error"> <!-- ALTER ENTIDADE-->
            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="formulario" >
                        ...
                        <div id="create-opcaoCardapio" class="content scaffold-create" role="main"> <!-- ALTER ENTIDADE-->
